      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full text-white">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#0a84ff]/20 border border-[#0a84ff]/30 text-[#0a84ff] text-xs font-bold uppercase tracking-wider mb-6"
          >
          ...
          >
            ...
            <span className="text-[#0a84ff] bg-clip-text">Chuyên Nghiệp Tận Nhà</span>
          </motion.h1>
          ...
          >
            Đội ngũ kỹ thuật tay nghề cao, tận tâm, có mặt ngay khi bạn cần. Sửa chữa, lắp đặt, vệ sinh thiết bị nhanh chóng tại TP.HCM. Bảo hành uy tín lên đến 12 tháng.
          </motion.p>
          ...
          >
            <a
              href="tel:0989577792"
              className="flex items-center gap-2 bg-[#0a84ff] hover:bg-[#0056b3] text-white px-8 py-4 rounded-2xl font-bold transition-all shadow-lg shadow-[#0a84ff]/30 btn-pulse cursor-pointer"
            >
